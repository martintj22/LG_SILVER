...
while { !isNull(findDisplay 1444) } do { if( kacfocus != _player ) exitwith {}; client_kacCamera camSetTarget _player; client_kacCamera camSetRelPos [0,2,2]; client_kacCamera camCommit 1; uisleep 0.5; };