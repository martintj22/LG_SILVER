...
class buycar {
	...
	class controls {
		...
		class RscListbox_Vehicle: client_RscListBox
		{
			idc = 1500;
		    colorText[] = {1, 1, 1, 1};
		...
		class RscListbox_Color: client_RscListBox
		{
			idc = 1501;
		    colorText[] = {1, 1, 1, 1};
		    colorActive[] = {0, 0, 0, 0.2};
		...
		class RscListbox_Finish: client_RscListBox
		{
			idc = 1502;
		    colorText[] = {1, 1, 1, 1};
		    colorActive[] = {0, 0, 0, 0.2};
...
class upgradecar {
	idd = 1444;
	name= "upgradecar";
	onLoad = "[""NEW""] spawn client_fnc_upgradeShop; client_kcCamera  = ""CAMERA"" camCreate (getPos player); showCinemaBorder true; client_kcCamera cameraEffect [""EXTERNAL"", ""BACK""];";	
	onunload = "deletevehicle spawnedvehicle; client_kcCamera cameraEffect [""TERMINATE"",""BACK""]; camDestroy client_kcCamera;";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class RscListbox_Vehicle: client_RscListbox
		{
			...
			w = 0.385 * safezoneW;
			h = 0.12 * safezoneH;
			onLBSelChanged = "[""CAR""] spawn client_fnc_upgradeShop;";
		};
		...
		class RscListbox_Color: client_RscListbox
		{
			...
			w = 0.192 * safezoneW;
			h = 0.065 * safezoneH;
			onLBSelChanged = "[""COLOR""] spawn client_fnc_upgradeShop;";
		};
		...
		class RscListbox_Finish: client_RscListbox
		{
			...
			w = 0.193 * safezoneW;
			h = 0.065 * safezoneH;
			onLBSelChanged = "[""FINISH""] spawn client_fnc_upgradeShop;";
		};

		class RscListbox_Colort: client_RscListbox
		{
			idc = 1503;
		    colorText[] = {1, 1, 1, 1};
		    colorActive[] = {0, 0, 0, 0.2};
			...
			w = 0.12 * safezoneW;
			h = 0.065 * safezoneH;
			onLBSelChanged = "[""TINT""] spawn client_fnc_upgradeShop;";
		};

		class RscListbox_Spoiler: client_RscListbox
		{
			idc = 1506;
		    colorText[] = {1, 1, 1, 1};
		    colorActive[] = {0, 0, 0, 0.2};
			...
			w = 0.12 * safezoneW;
			h = 0.065 * safezoneH;
			onLBSelChanged = "[""SPOILER""] spawn client_fnc_upgradeShop;";
		};

		class RscListbox_Finishl: client_RscListbox
		{
			idc = 1504;
		    colorText[] = {1, 1, 1, 1};
		    colorActive[] = {0, 0, 0, 0.2};
			...
			w = 0.12 * safezoneW;
			h = 0.065 * safezoneH;
			onLBSelChanged = "[""LIGHTS""] spawn client_fnc_upgradeShop;";
		};


		class RscListbox_Finishw: client_RscListbox
		{
			idc = 1505;
		    colorText[] = {1, 1, 1, 1};
		    colorActive[] = {0, 0, 0, 0.2};
			...
			w = 0.12 * safezoneW;
			h = 0.065 * safezoneH;
			onLBSelChanged = "[""WHEELS""] spawn client_fnc_upgradeShop;";
		};
...
class koiladmin {
	...
	class controls {
		...
		class RscListbox_players: client_RscListBox
		{
			idc = 1500;
			sizeEx = 0.033;
		    colorText[] = {1, 1, 1, 1};
		...
		class RscListbox_functions: client_RscListBox
		{
			idc = 1501;
			sizeEx = 0.033;
		    colorText[] = {1, 1, 1, 1};
